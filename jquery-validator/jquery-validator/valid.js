...
if((ofnam==true) && (olnam==true) && (ogen==true) && (oemail==true) && (omono==true) && (ousr==true) && (opas==true) && (orepas==true)){
 if(($("#fname").val()!="") && ($("#lname").val()!="") &&($("#gender").val()!="") &&($("#email").val()!="") &&($("#cellno").val()!="") &&($("#user").val()!="") &&($("#pass").val()!="") &&($("#repas").val()!="")){
     if(($("#fnamespan").val()=="")&&($("#lnamespan").val()=="")&& ($("#genderspan").val()=="")&&($("#emailspan").val()=="")&&($("#cellnospan").val()=="")&&($("#userspan").val()=="")&&($("#passspan").val()=="")&&($("#repasspan").val()=="")&& ($("#termsspan").val()==""))
      {
   $('#success').html('<center><h1><font color=green>Welcome to Binary Systems</h1><br><h4><font color=red>Submission Successful!</font></h4></center>')
     }
   }
  }
 }
